...
emailForm.addEventListener('submit', function(e) {
  ...
  // But show success message first
  ...
  // Note: The form will still submit to formsubmit.co
  // For a truly seamless experience, you might want to use fetch() instead
  // and prevent default, but this maintains the original functionality
});
